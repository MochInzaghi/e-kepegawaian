                    ...
                    <table class="table table-bordered">
                      ...
                      @foreach($data_pegawai as $pegawai)
                        <tr>
                          ...
                          <td>
                          <a href="datapegawai/{{ $pegawai->id }}/edit" class="btn btn-primary d-inline ml-3">Edit</a>
                          <form class="d-inline ml-3" action = "datapegawai/{{ $pegawai->id }}/delete" method="POST">
                            @csrf
                            @method("delete")
