...
<html>
    ...
    <body style="background-color: white; margin-top: 0.5cm; margin-left: 0.5cm; margin-right: 0.5cm; margin-bottom: 0.5cm;" onload="window.print()">
        <style>
            .font{
                font-size: 20px;
                font-family: "Arial";
                    ...
                    <div class="card-body">
                        ...
                        <div class="row" style="margin-right: 10px;">
                            <div class="col-8 col-sm-6 posisiperihal1">
                                ...
                                <p class="p1">Perihal   <span style="margin-left: 22px;">:</span> <strong>KENAIKAN GAJI BERKALA</strong></p>
                            </div>
                            ...
                            <div class="col-md-12 paragraf1">
                                <p class="p1" style="text-indent: 5em;">Kepala Dinas Komunikasi dan Informatika Kabupaten Malang dengan ini <p class="pp">memberitahukan bahwa berhubung dengan telah dipenuhinya masa kerja dan syarat–syarat<p class="pp">lainnya kepada :</p>
                            </div>
                                ...
                                <table style="border-color: #FFFFFF">
                                    <tbody>
                                        ...
                                        <tr class="d-flex" style="margin-top: 5px;">
                                            ...
                                            <td class="font" style="text-align: left; margin-left: 20px;">@currency($datakgb->getPegawai->gajipokok),-</td>
                                            <td class="font" style="margin-left: 120px; margin-top: 5px;"><b>PP Nomor 30 Tahun 2015</b></td>
                                        </tr>
                                        <tr class="d-flex" style="margin-top: 5px;">
                                            <td class="font" scope="row">Atas dasar Surat Keputusan terakhir tentang gaji/pangkat yang ditetapkan : </td>
                                        </tr>
                                        <tr class="d-flex" style="margin-top: 5px;">
                                            <td class="font" scope="row">a.</td>
                                            <td class="font" style="text-align: left">Oleh Pejabat</td>
                                            <td class="font" style="margin-left: 158px;">:</td>
                                            <td class="font" style="text-align: left; margin-left: 20px;">{{  $datakgb->olehpejabat }}</td>
                                        </tr>
                                        <tr class="d-flex" style="margin-top: 5px;">
                                            ...
                                            <td class="font" style="text-align: left; margin-left: 20px;">{{ date('d-m-Y', strtotime( $datakgb->tanggal )) }}<br>822.1/385/35.07.127/2019</td>                                            </td>
                                        </tr>
                                        </tr>
                                        <tr class="d-flex" style="margin-top: 5px;">
                                            ...
                                            <td class="font" style="text-align: left; margin-left: 20px;"><br>{{ date('d F Y', strtotime(  $datakgb->tgl_gaji)) }}</td>
                                        </tr>
                                        <tr class="d-flex" style="margin-top: 5px;">
                                            ...
                                            <td class="font" style="text-align: left; margin-left: 20px;"><br>{{  $datakgb->masakerja_tgl  }}</td>
                                        </tr>
                                        <tr class="d-flex" style="margin-top: 5px;">
                                            <td class="font" scope="row">Diberikan Kenaikan gaji berkala hingga memperoleh : </td>
                                        </tr>
                                        <tr class="d-flex" style="margin-top: 10px;">
                                            ...
                                            <td class="font" style="margin-left: 121px;">:</td>
                                            <td class="font" style="text-align: left; margin-left: 20px;"><b>@currency($datakgb->gajibaru),-</b></td>
                                            <td class="font" style="margin-left: 120px; margin-top: -5px"><b>PP Nomor 15 Tahun 2015</b></td>
                                        </tr>
                                        <tr class="d-flex" style="margin-top: 5px;">
                                            ...
                                            <td class="font" style="text-align: left; margin-left: 20px;">{{  $datakgb->masakerja  }}
                                                </td>
                                        </tr>
                                        <tr class="d-flex" style="margin-top: 5px;">
                                            ...
                                            <td class="font" style="text-align: left; margin-left: 20px;">{{  $datakgb->gol_ruang  }}</td>
                                        </tr>
                                        <tr class="d-flex" style="margin-top: 5px;">
                                            ...
                                            <td class="font" style="text-align: left; margin-left: 20px;">{{  date('d-m-Y', strtotime($datakgb->mulai_tgl))  }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            <div class="col-md-12 paragraf1">
                                <p style="text-indent: 5em; font-family: Arial; font-size: 20px; word-spacing: 1px;">Diharapkan agar sesuai dengan <u>Peraturan Pemerintah Repubik Indonesia Nomor 15 <p style="text-indent: 0.5em; font-family: Arial; font-size: 20px; word-spacing: 1px;">Tahun 2019</u> kepada Pegawai tersebut dapat dibayarkan penghasilanya berdasarkan gaji pokok</p> <p style="font-family: Arial; font-size: 20px; word-spacing: 1px; text-indent: 0.5em"">yang baru.</p>
                            </div>
