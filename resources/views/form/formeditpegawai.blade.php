                ...
                <div class="card-body">
                  ...
                  {{csrf_field()}}
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="nama" placeholder="Nama Pegawai" name="namapegawai" value="{{ old('namapegawai') ?? $dataPegawai->namapegawai }}">
                    </div>
                    <div class="form-group">
                      <label for="NIP">NIP</label>
                      <input type="text" class="form-control" id="nip" placeholder="NIP" name="nip" value="{{ old('nip') ?? $dataPegawai->nip }}">
                    </div>
                    <div class="form-group">
                      <label for="TTL">Tempat Tanggal Lahir</label>
                      <input type="text" class="form-control" id="ttl" placeholder="Tempat Tanggal Lahir" name="ttl" value="{{ old('ttl') ?? $dataPegawai->ttl }}">
                    </div>
                    <div class="form-group">
                      <label for="pangkat">Pangkat</label>
                      <input type="text" class="form-control" id="pangkat" placeholder="Pangkat" name="pangkat" value="{{ old('pangkat') ?? $dataPegawai->pangkat }}">
                    </div>
                    <div class="form-group">
                      <label for="jabatan">Jabatan</label>
                      <input type="text" class="form-control" id="jabatan" placeholder="Jabatan" name="jabatan" value="{{ old('jabatan') ?? $dataPegawai->jabatan }}">
                    </div>
                    <div class="form-group">
                      <label for="jenjang">Jenjang</label>
                      <input type="text" class="form-control" id="jenjang" placeholder="Jenjang" name="jenjang" value="{{ old('jenjang') ?? $dataPegawai->jenjang }}">
                    </div>
                    <div class="form-group">
                      <label for="notelp">Nomor Telepon</label>
                      <input type="text" class="form-control" id="notelp" placeholder="Nomor Telepon" name="notelp" value="{{ old('notelp') ?? $dataPegawai->notelp }}">
                    </div>
                    <div class="form-group">
                      <label for="KGB">KGB Terakhir</label>
                      <input type="date" class="form-control" id="kgb" placeholder="KGB Terakhir" name="kgb" value="{{ old('kgb') ?? $dataPegawai->kgb }}">
                    </div>
                    <div class="form-group">
                      <label for="KP">KP Terakhir</label>
                      <input type="date" class="form-control" id="kp" placeholder="KP Terakhir" name="kp" value="{{ old('kp') ?? $dataPegawai->kp }}">
                    </div>
                    <div class="form-group">
                      <label for="Gaji">Gaji Pokok</label>
                      <input type="text" class="form-control" id="gajipokok" placeholder="Gaji Pokok" name="gajipokok" value="{{ old('gajipokok') ?? $dataPegawai->gajipokok }}">
                    </div>
                    <div class="form-group">
