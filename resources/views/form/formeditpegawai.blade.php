                                ...
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="update" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nama" name="namapegawai"
                                                value="{{ old('namapegawai') ?? $dataPegawai->namapegawai }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="NIP">NIP</label>
                                            <input type="text" class="form-control" id="nip" name="nip"
                                                value="{{ old('nip') ?? $dataPegawai->nip }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="TTL">Tempat Tanggal Lahir</label>
                                            <input type="text" class="form-control" id="ttl" name="ttl"
                                                value="{{ old('ttl') ?? $dataPegawai->ttl }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="pangkat">Pangkat</label>
                                            <input type="text" class="form-control" id="pangkat" name="pangkat"
                                                value="{{ old('pangkat') ?? $dataPegawai->pangkat }}">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="jenjang" name="jenjang"
                                                value="{{ old('jenjang') ?? $dataPegawai->jenjang }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="notelp">Nomor Telepon</label>
                                            <input type="text" class="form-control" id="notelp" name="notelp"
                                                value="{{ old('notelp') ?? $dataPegawai->notelp }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="KGB">KGB Terakhir</label>
                                            <input type="date" class="form-control" id="kgb" name="kgb"
                                                value="{{ old('kgb') ?? $dataPegawai->kgb }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="KP">KP Terakhir</label>
                                            <input type="date" class="form-control" id="kp" name="kp"
                                                value="{{ old('kp') ?? $dataPegawai->kp }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="Gaji">Gaji Pokok</label>
                                            <input type="text" class="form-control" id="gajipokok" name="gajipokok"
                                                value="{{ old('gajipokok') ?? $dataPegawai->gajipokok }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="keterangan">Keterangan</label>
                                            <select id="keterangan" class="form-control" name="keterangan"
                                                value="{{ old('keterangan') ?? $dataPegawai->keterangan }}">
