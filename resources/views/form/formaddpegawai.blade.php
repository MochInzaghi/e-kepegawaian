                ...
                <ul class="nav">
                        ...
                        <div class="collapse" id="form-elements">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"><a class="nav-link"
                                        href="{{ asset('template') }}/pages/forms/basic_elements.html">Form Data
                                        Pegawai</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="tables">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ asset('template') }}/pages/tables/basic-table.html">Data Pegawai</a>
                                </li>
                            </ul>
                        </div>
                        <div class="collapse" id="tables">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ asset('template') }}/pages/tables/basic-table.html">Data KGB</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="{{ route('store.pegawai') }}" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="kgb"
                                                placeholder="KGB Terakhir" name="kgb">
                                        </div>
                                        <div class="form-group">
                                            <label for="KP">KP Terakhir</label>
                                            <input type="date" class="form-control" id="kp" placeholder="KP Terakhir"
                                                name="kp">
                                        </div>
                                        <div class="form-group">
