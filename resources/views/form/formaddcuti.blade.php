...
<head>
  ...
  <title>Form Add Data Cuti </title>
  <!-- plugins:css -->
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            ...
            <h3 class="welcome-sub-text">Silahkan Menambahkan Data Cuti </h3>
          </li>
        </ul>
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="{{asset('template')}}/pages/forms/basic_elements.html">Form Data Cuti</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{asset('template')}}/pages/tables/basic-table.html">Tabel Data Pegawai</a></li>
              </ul>
            </div>
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{asset('template')}}/pages/tables/basic-table.html">Tabel Data KGB</a></li>
              </ul>
            </div>
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{asset('template')}}/pages/tables/basic-table.html">Tabel Data Cuti</a></li>
              </ul>
            </div>
          </li>
        </ul>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Form Add Data Cuti</h4>
                  ...
                  {{csrf_field()}}
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" id="daritgl" placeholder="Dari Tanggal" name="daritgl">
                    </div>
                    <div class="form-group">
                      <label for="sampaitgl">Sampai Tanggal</label>
                      <input type="date" class="form-control" id="sampaitgl" placeholder="Sampai Tanggal" name="sampaitgl">
                    </div>
                    <div class="form-group">
