(function ($) {
  ...
  $(function () {
    ...
    if ($("#status-summary-pegawai-dinas").length) {
      var statusSummaryChartCanvas = document.getElementById("status-summary-pegawai-dinas").getContext('2d');;
      var statusData = {
        labels: ["SUN", "MON", "TUE", "WED", "THU", "FRI"],
        datasets: [{
          label: '# of Votes',
          data: [32, 50, 68, 70, 10, 12, 80],
    ...
    if ($("#status-summary-pegawai-honorer").length) {
      var statusSummaryChartCanvas = document.getElementById("status-summary-pegawai-honorer").getContext('2d');;
      var statusData = {
        labels: ["SUN", "MON", "TUE", "WED", "THU", "FRI"],
        datasets: [{
          label: '# of Votes',
